angular
    .module('altairApp')
    	.controller("xreporthistoryCoal",[
    	                          ...
    	                          '$filter',
    	                          'user_data',
	        function ($scope,$rootScope,$state,utils,mainService,sweet,mineralData,$filter,user_data) {   
	            ...
	            $scope.PlanExploration = {
		                dataSource: {
		                    ...
		                    transport: {
		                    	read:  {
		                    		...
		                    		data: {"custom":"where divisionid="+user_data.divisionid+" and xtype=0 and repstatusid=1", sort:[{"field":"submissiondate","dir":"asc"}]},
		               ...
		               // toolbar:kendo.template($("#export").html()),
		                ...
		                columns: [
		                          ...
		                          { field:"reportyear",width: "140px", title: "<span data-translate='Report year'></span>" },
		                          { 
		                          	 template: kendo.template($("#status").html()), width: "140px", title: "<span data-translate='Status'></span>"   	                                
		                           },	  
		                          /* { 
