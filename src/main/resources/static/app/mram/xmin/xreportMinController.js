	            ...
	            $scope.PlanExploration = {
		                dataSource: {
		                    ...
		                    transport: {
		                    	read:  {
		                    		...
		                    		data: {"custom":"where reporttype=4 and divisionid=1 and xtype=0 and repstatusid=7", sort:[{"field":"submissiondate","dir":"asc"}]},
		               ...
		               // toolbar:kendo.template($("#export").html()),
		                ...
		                columns: [
		                          ...
		                          { field:"submissiondate", title: "Илгээсэн огноо></span>" },
		                          { 
