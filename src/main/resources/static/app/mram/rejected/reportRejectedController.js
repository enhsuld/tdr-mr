	            ...
	            $scope.PlanExploration = {
		                dataSource: {
		                    ...
		                    transport: {
		                    	read:  {
		                    		...
		                    		data: {"custom":"where divisionid="+user_data.divisionid+" and repstatusid=3", sort:[{"field":"submissiondate","dir":"asc"}]},
		               ...
		               // toolbar:kendo.template($("#export").html()),
		                ...
		                columns: [
		                          ...
		                          { field:"reporttype", values:[{text:"Тайлан",value:"4"},{text:"Төлөвлөгөө",value:"3"}], title: "Төрөл"},		 
		                          { field:"licenseXB", title: "<span data-translate='License number'></span>"},		 
		                          { field:"reportyear", title: "<span data-translate='Report year'></span>" },
		                          { 
		                        	 field:"repstatusid", values:[{text:"Хадгалсан",value:"0"},{text:"Засварт буцаасан",value:"2"},{text:"Татгалзсан",value:"3"},{text:"Илгээсэн",value:"7"},{text:"Хүлээлгэн өгсөн",value:"1"}],
