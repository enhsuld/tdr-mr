		        ...
		        .state("restricted.pages.zeroAnswer", {
		            ...
		            resolve: {
                        ...
                        ann: function($http,$stateParams){
                            return $http({ method: 'GET', url: '/user/service/rs/com.peace.users.model.mram.LnkReqAnn/reqid/'+$stateParams.reqid})
                               .then(function (data) {
                                   return data.data;
                               });
                       },
                        pv: function($http,$stateParams){
                           return $http({ method: 'GET', url: '/user/service/rs/com.peace.users.model.mram.LnkReqPv/reqid/'+$stateParams.reqid})
                              .then(function (data) {
                                  return data.data;
                              });
                       },
        	...
        	.state("restricted.pages.planMVConfig", {
	           ...
	           resolve: {
	               ...
	               mv: function($http,$stateParams){
                        return $http({ method: 'GET', url: '/user/service/rs/com.peace.users.model.mram.LnkReqAnn/reqid/'+$stateParams.id})
                           .then(function (data) {
                               return data.data;
                           });
                   },
                   rrq: function($http,$stateParams){
                       return $http({ method: 'GET', url: '/user/service/rs/com.peace.users.model.mram.RegReportReq/id/'+$stateParams.id})
                          .then(function (data) {
                              return data.data;
                          });
                   },
	  	   ...
	  	   .state("restricted.pages.planPVConfig", {
	           ...
	           resolve: {
	               ...
	               pv: function($http,$stateParams){
                       return $http({ method: 'GET', url: '/user/service/rs/com.peace.users.model.mram.LnkReqPv/reqid/'+$stateParams.id})
                          .then(function (data) {
                              return data.data;
                          });
                  },
           ...
           .state("restricted.pages.annualplanGov", {
            ...
            .state("restricted.pages.GovReportFormA", {
                  ...
                  resolve: {
                      ...
                      sgt: function($http, $stateParams){
                          return $http({ method: 'get', url: '/user/service/rs/com.peace.users.model.mram.AnnualRegistration/id/'+$stateParams.param})
                              .then(function (data) {
                                  return data.data;
                              });
                      },
                      ...
                      ann: function($http,$stateParams){
                          return $http({ method: 'GET', url: '/user/service/ann/com.peace.users.model.mram.LnkReqAnn/reqid/'+$stateParams.param})
                             .then(function (data) {
                                 return data.data;
                             });
                      },
                      rrq: function($http,$stateParams){
                          return $http({ method: 'GET', url: '/user/service/ann/com.peace.users.model.mram.RegReportReq/id/'+$stateParams.param})
                             .then(function (data) {
                                 return data.data;
                             });
                      },
