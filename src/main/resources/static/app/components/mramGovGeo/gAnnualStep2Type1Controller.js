    ...
    .module('altairApp')
    	.controller("annualCtrlGovStep2Type1",[
	        ...
	        function ($scope,$rootScope,$state,utils,mainService,sweet,lic_type,app_status,rep_type,p_group) {   
	    	    ...
	    	    $scope.rrid=0;
	    	    var repstatuses = [{text:"Засварт буцаасан",value:"2"},{text:"Илгээсэн",value:"7"},{text:"Хүлээлгэн өгсөн",value:"1"}];
		                ...
		                dataSource: {
		                    ...
		                    transport: {
		                    	read:  {
		                            ...
		                            data: {"custom":"where reporttype=4 and divisionid=3 and groupid=10 and repstepid=8 and repstatusid in (7,2) "},
