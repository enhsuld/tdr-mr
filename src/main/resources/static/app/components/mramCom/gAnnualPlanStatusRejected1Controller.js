        ...
        function ($scope, $rootScope, $state, utils, mainService, sweet, $stateParams, p_deposit) {
            ...
            $scope.PlanExploration = {
                dataSource: {
                    ...
                    transport: {
                        read: {
                            ...
                            data: {"custom": "where repstatusid = 2 and rejectstep!=0 and reject!=0 and divisionid = 1 and reporttype = " + $stateParams.reporttype},
                ...
                columns: [
                    ...
                    {
                        template: kendo.template($("#main").html()), width: "80px"
                    }],
                dataBound: function () {
                    var rows = this.items();
                    $(rows).each(function () {
