angular
    .module('altairApp')
    	.controller("annualNewCtrl",[
    	                          ...
    	                          'mineralData',
	        'p_div',
	        function ($compile,$q,$scope,$http,$timeout,$rootScope,$state,utils,mainService,sweet,$resource, DTOptionsBuilder, DTColumnBuilder,mineralData,p_div) {
	            ...
	            $scope.REPBundle = {
		                ...
		                columns: [		
                            	...
                            	{ field:"divisionId",title: "Хэлтэс", values:p_div},
		                        /*  { 
