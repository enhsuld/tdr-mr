    ...
    .module('altairApp')
    	.controller("annualCtrl",[
	        ...
	        function ($compile,$q,$scope,$http,$timeout,$rootScope,$state,$window,utils,mainService,sweet,lic_type,app_status,rep_type,sel_data,officers,group_data,$resource, DTOptionsBuilder, DTColumnBuilder,mineralData) {   
	            ...
	            var mgroup=[{text:"Үнэт, өнгөт металл", value:10},{text:"ЦИМ, ГХЭ, харь ховор металл", value:11},{text:"Металл бус, түгээмэл тархацтай ашигт малтмал", value:12},{text:"Нүүрс,  уламжлалт бус газрын тос", value:13}];
	            ...
	            $scope.REPBundle = {
		                ...
		                /*          { field:"mineralid", title: "<span data-translate='Mineral'></span>", values:mineralData},*/
		                          {template: kendo.template($("#isconfiged").html()), title: "<span data-translate='Тохиргоо хийсэн эсэх'></span>" },	
		                          { 
