angular
  .module('altairApp')
  .controller("dataFormsController47", ['$scope', 'mainService', '$stateParams', function($scope, mainService,$stateParams) {
    ...
    $scope.proleGrid1 = {
      dataSource: {
        ...
        transport: {
          read: {
            url: "/user/angular/DataExcelGeorep1",
      ...
      columns:[
 		...
 		{field:"data2", title: "#"},
   		...
   		{title:"Төлөвлөсөн",columns:[{title:"Ажлын хэмжээ", field:"data5"},{title:"Төсөв, ₮", field:"data6"}]},
   		{title:"Гүйцэтгэсэн",columns:[{title:"Нэгжийн өртөг", field:"data7"},{title:"Ажлын хэмжээ", field:"data8"},{title:"Төсөв, ₮", field:"data9"}]},
   	],
      editable: false
    };
