  ...
  .controller("dataFormsController56", ['$scope', 'mainService', '$stateParams', function($scope, mainService,$stateParams) {
    ...
    $scope.proleGrid1 = {
      dataSource: {
        ...
        transport: {
          read: {
            url: "/user/angular/DataExcelGeorep10",
      ...
      columns:[
 		...
 		{field:"data3", title: "Эхний үлдэгдэл"},
 		{field:"data4", title: "Нэмэгдсэн"},
 		{field:"data5", title: "Хасагдсан"},
 		{field:"data6", title: "Эцсийн үлдэгдэл"},
   	],
      editable: false
    };
