angular
  ...
  .controller("dataFormsController182", ['$scope', 'mainService', function($scope, mainService) {
    $scope.domain = "com.peace.users.model.mram.DataMinPlan2_1";

    mainService.withdomain("post", "/getPlanListByForm/182").then(function(data) {
      console.log(data);
    });
    ...
    $scope.proleGrid1 = {
      dataSource: {
        ...
        transport: {
          read: {
            url: "/user/angular/DataMinPlan2_1",
    ...
    /*function detailInit(e) {
        $("<div/>").appendTo(e.detailCell).kendoGrid({
            dataSource: {
                ...
                serverFiltering: true,
                pageSize: 10,
                filter: { field: "data1", operator: "eq", value: e.data.data1 }
            },
