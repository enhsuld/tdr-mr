angular
    ...
    .controller('annualplanFormCtrl', [
        ...
        'minetypes',
        'deposits',
        function ($scope, $rootScope, utils, $timeout, $window, Upload, $stateParams, mainService, fileUpload, sweet, org_data, $state, sgt, xonoff, note_data, ann, pv, minerals, concetrates, $filter, minetypes, deposits) {
            $scope.pv = pv;
            $scope.config = ann;
            $scope.concetrates = concetrates;
            $scope.minerals = minerals;
            $scope.minetypes = minetypes;
            $scope.deposits = deposits;
            $scope.orgDataStructure = {
                org_data:
                    [
                        {
                            label: "Овог",
                ...
                workers_data: [
                    {
                        label: "Ерөнхий инженер",
                        name: "gengineer",
                        mobile: "gengineerphone",
                        email: "gengineermail"
                    },
                    {
                        label: "Геологич",
                        name: "geologist",
                        mobile: "geologistphone",
                        email: "geologistmail"
                    },
                    {
                        label: "Маркшейдер",
                        name: "msurveyor",
                        mobile: "msurveyorphone",
                        email: "msurveyoremail"
                    },
                    {
                        label: "Нягтлан",
                        name: "accountant",
                    ...
                    },
                    {
                        label: "Эдийн засагч",
                        name: "economist",
                        mobile: "economistphone",
                        email: "economistemail"
                    },
                    {
                        label: "Уурхайн дарга",
                        name: "minehead",
                ...
                tz_data_mv: [
                    ...
                    {
                        label: "Ашигт малтмалын нэр",
                        value: "mineralid",
                        type: "id",
                        dataset: "minerals"
                    },
                    {
                        label: "Ашигт малтмалын төрөл",
                        value: "deposidid",
                        type: "id",
                        dataset: "deposits"
                    },
                    {
                        label: "Хөрөнгө оруулагч улс",
                        value: "countries",
                        type: "text"
                    },
                    {
                        label: "ТЭЗҮ хүлээн авсан/батлуулсан (он, сар, өдөр)",
                        value: "appdate",
                        type: "text"
                    },
                    {
                        label: "ТЭЗҮ-д тооцсон жилийн хүч чадал (Мян.тн/жил)",
                        value: "yearcapacity",
                        type: "text"
                    },
                    {
                        label: "Ашиглах нийт хугацаа (Жилээр)",
                        value: "workyear",
                        type: "text"
                    },
                    {
                        label: "Ашиглалтын технологи",
                        value: "minetypeid",
                        type: "id",
                        dataset: "minetypes"
                    },
                    {
                        label: "Улсын төсвийн хөрөнгөөр хийсэн хайгуулын ажлын нөхөн төлбөрийн гэрээтэй эсэх",
                        value: "statebudgetid",
                        type: "boolean"
                    },
                    {
                        label: "Улсын комисс ажилласан тухай",
                        value: "komissid",
                        type: "boolean"
                    },
                    {
                        label: "Ашиглалтанд хүлээж авсан огноо",
                        value: "komissdate",
                        type: "text"
                    },
                    {
                    ...
                    {
                        label: "Ашиглалт эхэлсэн огноо",
                        value: "startdate",
                        type: "text"
                    },
                    {
                        label: "Тэсэлгээний ажил",
                        value: "bombid",
                        type: "id",
                        dataset: "booleanArray"
                    },
                    {
                        label: "Гүйцэтгэгч",
                        value: "bombtype",
                ...
                tz_data_pv: [
                    {
                        label: "Баяжуулах үйлдвэрийн нэр",
                        value: "factoryname",
                        type: "text"
                    },
                    {
                    ...
                    {
                        label: "Хөрөнгө оруулалтын хувь хэмжээ",
                        value: "invperccent",
                        type: "text"
                    },
                    {
                    ...
                    {
                        label: "ТЭЗҮ боловсруулсан ААН-ийн нэр",
                        value: "tezulp",
                        type: "text"
                    },
                    {
                    ...
                    {
                        label: "Түүхий эд авах уурхайн нэр",
                        value: "rawmine",
                        type: "text"
                    }
                ]
            ...
            $scope.bombtypes = [
                {
                    "value": "1",
                    "text": "Өөрөө гүйцэтгэх"
                },
                {
                    "value": "2",
                    "text": "Гэрээгээр гүйцэтгүүлэх"
                },
                {
                    "value": "3",
                    "text": "Үгүй"
            ...
            $scope.getValue = function (column, dataset) {
                return ($filter('filter')($scope[dataset], {value: column})
                    != undefined && $filter('filter')($scope[dataset], {value: column}).length > 0
                )
                    ? $filter('filter')($scope[dataset], {value: column})[0].text : "";
            }

            $scope.$on('$viewContentLoaded', function () {
                $timeout(function () {
                    $("#reportStatusArea").css("max-height", $("#orgDataArea").height());
                }, 5000);
            });
