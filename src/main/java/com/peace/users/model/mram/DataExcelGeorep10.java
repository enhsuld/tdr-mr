...
@Entity
@Table(name="DATA_EXCEL_GEOREP10")
@NamedQuery(name="DataExcelGeorep10.findAll", query="SELECT d FROM DataExcelGeorep10 d")
public class DataExcelGeorep10 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_GEOREP10_SEQ", sequenceName="DATA_EXCEL_GEOREP10_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_GEOREP10_SEQ")
