...
@Entity
@Table(name="DATA_EXCEL_COALREP6_1")
@NamedQuery(name="DataExcelCoalrep6_1.findAll", query="SELECT d FROM DataExcelCoalrep6_1 d")
public class DataExcelCoalrep6_1 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP6_1_SEQ", sequenceName="DATA_EXCEL_COALREP6_1_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP6_1_SEQ")
