...
@Entity
@Table(name="DATA_EXCEL_MINREP8_1")
@NamedQuery(name="DataExcelMinrep8_1.findAll", query="SELECT d FROM DataExcelMinrep8_1 d")
public class DataExcelMinrep8_1 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP8_1_SEQ", sequenceName="DATA_EXCEL_MINREP8_1_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP8_1_SEQ")
