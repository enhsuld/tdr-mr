...
@Entity
@Table(name="DATA_EXCEL_GEOPLAN1")
@NamedQuery(name="DataExcelGeoplan1.findAll", query="SELECT d FROM DataExcelGeoplan1 d")
public class DataExcelGeoplan1 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_GEOPLAN1_SEQ", sequenceName="DATA_EXCEL_GEOPLAN1_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_GEOPLAN1_SEQ")
