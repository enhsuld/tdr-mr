...
@Entity
@Table(name="DATA_EXCEL_COALREP10")
@NamedQuery(name="DataExcelCoalrep10.findAll", query="SELECT d FROM DataExcelCoalrep10 d")
public class DataExcelCoalrep10 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP10_SEQ", sequenceName="DATA_EXCEL_COALREP10_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP10_SEQ")
