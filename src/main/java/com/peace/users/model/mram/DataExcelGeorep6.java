...
@Entity
@Table(name="DATA_EXCEL_GEOREP6")
@NamedQuery(name="DataExcelGeorep6.findAll", query="SELECT d FROM DataExcelGeorep6 d")
public class DataExcelGeorep6 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_GEOREP6_SEQ", sequenceName="DATA_EXCEL_GEOREP6_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_GEOREP6_SEQ")
