 ...
 */
@Entity
@Table(name="DATA_COAL_FORM_2")
@NamedQuery(name="DataCoalForm2.findAll", query="SELECT d FROM DataCoalForm2 d")
public class DataCoalForm2 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_COAL_FORM_2_SEQ", sequenceName="DATA_COAL_FORM_2_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_COAL_FORM_2_SEQ")
	...
	public String toString() {
		return "DataCoalForm2 [id=" + id + ", data1=" + data1 + ", data10=" + data10 + ", data11=" + data11
