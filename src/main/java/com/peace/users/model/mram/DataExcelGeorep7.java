...
@Entity
@Table(name="DATA_EXCEL_GEOREP7")
@NamedQuery(name="DataExcelGeorep7.findAll", query="SELECT d FROM DataExcelGeorep7 d")
public class DataExcelGeorep7 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_GEOREP7_SEQ", sequenceName="DATA_EXCEL_GEOREP7_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_GEOREP7_SEQ")
