...
@Entity
@Table(name="DATA_EXCEL_COALREP3")
@NamedQuery(name="DataExcelCoalrep3.findAll", query="SELECT d FROM DataExcelCoalrep3 d")
public class DataExcelCoalrep3 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP3_SEQ", sequenceName="DATA_EXCEL_COALREP3_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP3_SEQ")
