...
@Entity
@Table(name="DATA_EXCEL_COALREP9")
@NamedQuery(name="DataExcelCoalrep9.findAll", query="SELECT d FROM DataExcelCoalrep9 d")
public class DataExcelCoalrep9 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP9_SEQ", sequenceName="DATA_EXCEL_COALREP9_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP9_SEQ")
