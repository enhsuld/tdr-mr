...
@Entity
@Table(name="DATA_EXCEL_MINREP12")
@NamedQuery(name="DataExcelMinrep12.findAll", query="SELECT d FROM DataExcelMinrep12 d")
public class DataExcelMinrep12 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP12_SEQ", sequenceName="DATA_EXCEL_MINREP12_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP12_SEQ")
