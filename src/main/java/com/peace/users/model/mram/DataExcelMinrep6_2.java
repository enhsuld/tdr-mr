...
@Entity
@Table(name="DATA_EXCEL_MINREP6_2")
@NamedQuery(name="DataExcelMinrep6_2.findAll", query="SELECT d FROM DataExcelMinrep6_2 d")
public class DataExcelMinrep6_2 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP6_2_SEQ", sequenceName="DATA_EXCEL_MINREP6_2_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP6_2_SEQ")
