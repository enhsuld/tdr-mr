...
@Entity
@Table(name="DATA_EXCEL_GEOREP2")
@NamedQuery(name="DataExcelGeorep2.findAll", query="SELECT d FROM DataExcelGeorep2 d")
public class DataExcelGeorep2 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_GEOREP2_SEQ", sequenceName="DATA_EXCEL_GEOREP2_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_GEOREP2_SEQ")
