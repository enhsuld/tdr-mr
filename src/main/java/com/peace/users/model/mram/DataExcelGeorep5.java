...
@Entity
@Table(name="DATA_EXCEL_GEOREP5")
@NamedQuery(name="DataExcelGeorep5.findAll", query="SELECT d FROM DataExcelGeorep5 d")
public class DataExcelGeorep5 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_GEOREP5_SEQ", sequenceName="DATA_EXCEL_GEOREP5_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_GEOREP5_SEQ")
