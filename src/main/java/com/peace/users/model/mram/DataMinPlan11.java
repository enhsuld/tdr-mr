 ...
 */
@Entity
@Table(name="DATA_MIN_PLAN_11")
@NamedQuery(name="DataMinPlan11.findAll", query="SELECT d FROM DataMinPlan11 d")
public class DataMinPlan11 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_MIN_PLAN_11_SEQ", sequenceName="DATA_MIN_PLAN_11_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_MIN_PLAN_11_SEQ")
