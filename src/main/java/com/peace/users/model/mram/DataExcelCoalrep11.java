...
@Entity
@Table(name="DATA_EXCEL_COALREP11")
@NamedQuery(name="DataExcelCoalrep11.findAll", query="SELECT d FROM DataExcelCoalrep11 d")
public class DataExcelCoalrep11 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP11_SEQ", sequenceName="DATA_EXCEL_COALREP11_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP11_SEQ")
