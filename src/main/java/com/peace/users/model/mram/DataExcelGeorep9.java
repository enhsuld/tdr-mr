...
@Entity
@Table(name="DATA_EXCEL_GEOREP9")
@NamedQuery(name="DataExcelGeorep9.findAll", query="SELECT d FROM DataExcelGeorep9 d")
public class DataExcelGeorep9 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_GEOREP9_SEQ", sequenceName="DATA_EXCEL_GEOREP9_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_GEOREP9_SEQ")
