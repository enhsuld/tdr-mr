 ...
 */
@Entity
@Table(name="DATA_MIN_PLAN_12")
@NamedQuery(name="DataMinPlan12.findAll", query="SELECT d FROM DataMinPlan12 d")
public class DataMinPlan12 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_MIN_PLAN_12_SEQ", sequenceName="DATA_MIN_PLAN_12_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_MIN_PLAN_12_SEQ")
