...
@Entity
@Table(name="DATA_EXCEL_GEOREP3")
@NamedQuery(name="DataExcelGeorep3.findAll", query="SELECT d FROM DataExcelGeorep3 d")
public class DataExcelGeorep3 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_GEOREP3_SEQ", sequenceName="DATA_EXCEL_GEOREP3_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_GEOREP3_SEQ")
