...
@Entity
@Table(name="DATA_EXCEL_MINREP19")
@NamedQuery(name="DataExcelMinrep19.findAll", query="SELECT d FROM DataExcelMinrep19 d")
public class DataExcelMinrep19 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP19_SEQ", sequenceName="DATA_EXCEL_MINREP19_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP19_SEQ")
