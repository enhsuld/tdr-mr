...
@Entity
@Table(name="DATA_EXCEL_COALREP2_1")
@NamedQuery(name="DataExcelCoalrep2_1.findAll", query="SELECT d FROM DataExcelCoalrep2_1 d")
public class DataExcelCoalrep2_1 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP2_1_SEQ", sequenceName="DATA_EXCEL_COALREP2_1_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP2_1_SEQ")
