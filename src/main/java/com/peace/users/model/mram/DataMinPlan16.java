 ...
 */
@Entity
@Table(name="DATA_MIN_PLAN_16")
@NamedQuery(name="DataMinPlan16.findAll", query="SELECT d FROM DataMinPlan16 d")
public class DataMinPlan16 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_MIN_PLAN_16_SEQ", sequenceName="DATA_MIN_PLAN_16_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_MIN_PLAN_16_SEQ")
