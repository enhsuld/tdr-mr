...
@Entity
@Table(name="DATA_EXCEL_COALREP2")
@NamedQuery(name="DataExcelCoalrep2.findAll", query="SELECT d FROM DataExcelCoalrep2 d")
public class DataExcelCoalrep2 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP2_SEQ", sequenceName="DATA_EXCEL_COALREP2_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP2_SEQ")
