 ...
 */
@Entity
@Table(name="DATA_MIN_PLAN_2_2")
@NamedQuery(name="DataMinPlan2_2.findAll", query="SELECT d FROM DataMinPlan2_2 d")
public class DataMinPlan2_2 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_MIN_PLAN_2_2_SEQ", sequenceName="DATA_MIN_PLAN_2_2_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_MIN_PLAN_2_2_SEQ")
	@Column(name = "ID", unique = true, nullable = false, precision = 22, scale = 0)
	private long id;

	@Override
	public String toString() {
		return "DataMinPlan2_2 [id=" + id + ", data1=" + data1 + ", data10=" + data10 + ", data11=" + data11
	...
	private Double data19, data20, data21, data22, data23, data24;
