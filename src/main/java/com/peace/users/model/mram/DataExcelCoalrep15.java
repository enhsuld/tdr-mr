...
@Entity
@Table(name="DATA_EXCEL_COALREP15")
@NamedQuery(name="DataExcelCoalrep15.findAll", query="SELECT d FROM DataExcelCoalrep15 d")
public class DataExcelCoalrep15 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP15_SEQ", sequenceName="DATA_EXCEL_COALREP15_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP15_SEQ")
