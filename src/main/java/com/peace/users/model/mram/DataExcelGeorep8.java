...
@Entity
@Table(name="DATA_EXCEL_GEOREP8")
@NamedQuery(name="DataExcelGeorep8.findAll", query="SELECT d FROM DataExcelGeorep8 d")
public class DataExcelGeorep8 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_GEOREP8_SEQ", sequenceName="DATA_EXCEL_GEOREP8_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_GEOREP8_SEQ")
