...
@Entity
@Table(name="DATA_EXCEL_COALREP14")
@NamedQuery(name="DataExcelCoalrep14.findAll", query="SELECT d FROM DataExcelCoalrep14 d")
public class DataExcelCoalrep14 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP14_SEQ", sequenceName="DATA_EXCEL_COALREP14_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP14_SEQ")
