...
@Entity
@Table(name="DATA_EXCEL_COALREP13")
@NamedQuery(name="DataExcelCoalrep13.findAll", query="SELECT d FROM DataExcelCoalrep13 d")
public class DataExcelCoalrep13 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP13_SEQ", sequenceName="DATA_EXCEL_COALREP13_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP13_SEQ")
