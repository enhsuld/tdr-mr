...
@Entity
@Table(name="DATA_EXCEL_COALREP7")
@NamedQuery(name="DataExcelCoalrep7.findAll", query="SELECT d FROM DataExcelCoalrep7 d")
public class DataExcelCoalrep7 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP7_SEQ", sequenceName="DATA_EXCEL_COALREP7_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP7_SEQ")
