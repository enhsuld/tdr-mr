...
@Entity
@Table(name="DATA_EXCEL_MINREP7")
@NamedQuery(name="DataExcelMinrep7.findAll", query="SELECT d FROM DataExcelMinrep7 d")
public class DataExcelMinrep7 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP7_SEQ", sequenceName="DATA_EXCEL_MINREP7_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP7_SEQ")
