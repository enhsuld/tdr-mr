...
@Entity
@Table(name="DATA_EXCEL_COALREP19")
@NamedQuery(name="DataExcelCoalrep19.findAll", query="SELECT d FROM DataExcelCoalrep19 d")
public class DataExcelCoalrep19 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP19_SEQ", sequenceName="DATA_EXCEL_COALREP19_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP19_SEQ")
