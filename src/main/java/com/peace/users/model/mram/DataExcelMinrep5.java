...
@Entity
@Table(name="DATA_EXCEL_MINREP5")
@NamedQuery(name="DataExcelMinrep5.findAll", query="SELECT d FROM DataExcelMinrep5 d")
public class DataExcelMinrep5 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP5_SEQ", sequenceName="DATA_EXCEL_MINREP5_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP5_SEQ")
