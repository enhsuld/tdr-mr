...
@Entity
@Table(name="DATA_EXCEL_MINREP16")
@NamedQuery(name="DataExcelMinrep16.findAll", query="SELECT d FROM DataExcelMinrep16 d")
public class DataExcelMinrep16 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP16_SEQ", sequenceName="DATA_EXCEL_MINREP16_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP16_SEQ")
