...
@Entity
@Table(name="DATA_EXCEL_MINREP4_2")
@NamedQuery(name="DataExcelMinrep4_2.findAll", query="SELECT d FROM DataExcelMinrep4_2 d")
public class DataExcelMinrep4_2 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP4_2_SEQ", sequenceName="DATA_EXCEL_MINREP4_2_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP4_2_SEQ")
