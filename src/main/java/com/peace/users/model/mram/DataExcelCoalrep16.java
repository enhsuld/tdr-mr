...
@Entity
@Table(name="DATA_EXCEL_COALREP16")
@NamedQuery(name="DataExcelCoalrep16.findAll", query="SELECT d FROM DataExcelCoalrep16 d")
public class DataExcelCoalrep16 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP16_SEQ", sequenceName="DATA_EXCEL_COALREP16_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP16_SEQ")
