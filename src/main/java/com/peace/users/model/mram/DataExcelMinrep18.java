...
@Entity
@Table(name="DATA_EXCEL_MINREP18")
@NamedQuery(name="DataExcelMinrep18.findAll", query="SELECT d FROM DataExcelMinrep18 d")
public class DataExcelMinrep18 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP18_SEQ", sequenceName="DATA_EXCEL_MINREP18_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP18_SEQ")
