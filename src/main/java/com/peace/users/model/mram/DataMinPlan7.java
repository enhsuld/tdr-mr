 ...
 */
@Entity
@Table(name="DATA_MIN_PLAN_7")
@NamedQuery(name="DataMinPlan7.findAll", query="SELECT d FROM DataMinPlan7 d")
public class DataMinPlan7 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_MIN_PLAN_7_SEQ", sequenceName="DATA_MIN_PLAN_7_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_MIN_PLAN_7_SEQ")
	...
	public Long getData_index() {
		return dataIndex;
	}

	public void setData_index(Long dataIndex) {
