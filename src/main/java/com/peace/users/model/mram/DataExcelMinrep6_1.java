...
@Entity
@Table(name="DATA_EXCEL_MINREP6_1")
@NamedQuery(name="DataExcelMinrep6_1.findAll", query="SELECT d FROM DataExcelMinrep6_1 d")
public class DataExcelMinrep6_1 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP6_1_SEQ", sequenceName="DATA_EXCEL_MINREP6_1_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP6_1_SEQ")
