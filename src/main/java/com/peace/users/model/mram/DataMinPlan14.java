 ...
 */
@Entity
@Table(name="DATA_MIN_PLAN_14")
@NamedQuery(name="DataMinPlan14.findAll", query="SELECT d FROM DataMinPlan14 d")
public class DataMinPlan14 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_MIN_PLAN_14_SEQ", sequenceName="DATA_MIN_PLAN_14_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_MIN_PLAN_14_SEQ")
