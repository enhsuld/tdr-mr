...
@Entity
@Table(name="DATA_EXCEL_MINREP3B")
@NamedQuery(name="DataExcelMinrep3b.findAll", query="SELECT d FROM DataExcelMinrep3b d")
public class DataExcelMinrep3b implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP3B_SEQ", sequenceName="DATA_EXCEL_MINREP3B_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP3B_SEQ")
