...
@Entity
@Table(name="DATA_EXCEL_COALREP4")
@NamedQuery(name="DataExcelCoalrep4.findAll", query="SELECT d FROM DataExcelCoalrep4 d")
public class DataExcelCoalrep4 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP4_SEQ", sequenceName="DATA_EXCEL_COALREP4_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP4_SEQ")
