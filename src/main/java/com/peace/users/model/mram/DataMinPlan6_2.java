 ...
 */
@Entity
@Table(name="DATA_MIN_PLAN_6_2")
@NamedQuery(name="DataMinPlan6_2.findAll", query="SELECT d FROM DataMinPlan6_2 d")
public class DataMinPlan6_2 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_MIN_PLAN_6_2_SEQ", sequenceName="DATA_MIN_PLAN_6_2_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_MIN_PLAN_6_2_SEQ")
