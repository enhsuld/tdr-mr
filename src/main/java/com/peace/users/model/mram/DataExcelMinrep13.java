...
@Entity
@Table(name="DATA_EXCEL_MINREP13")
@NamedQuery(name="DataExcelMinrep13.findAll", query="SELECT d FROM DataExcelMinrep13 d")
public class DataExcelMinrep13 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP13_SEQ", sequenceName="DATA_EXCEL_MINREP13_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP13_SEQ")
