...
@Entity
@Table(name="DATA_EXCEL_COALREP5")
@NamedQuery(name="DataExcelCoalrep5.findAll", query="SELECT d FROM DataExcelCoalrep5 d")
public class DataExcelCoalrep5 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_COALREP5_SEQ", sequenceName="DATA_EXCEL_COALREP5_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_COALREP5_SEQ")
