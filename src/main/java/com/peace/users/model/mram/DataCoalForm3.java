 ...
 */
@Entity
@Table(name="DATA_COAL_FORM_3")
@NamedQuery(name="DataCoalForm3.findAll", query="SELECT d FROM DataCoalForm3 d")
public class DataCoalForm3 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_COAL_FORM_3_SEQ", sequenceName="DATA_COAL_FORM_3_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_COAL_FORM_3_SEQ")
