...
@Entity
@Table(name="DATA_EXCEL_MINREP14")
@NamedQuery(name="DataExcelMinrep14.findAll", query="SELECT d FROM DataExcelMinrep14 d")
public class DataExcelMinrep14 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP14_SEQ", sequenceName="DATA_EXCEL_MINREP14_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP14_SEQ")
