...
@Entity
@Table(name="DATA_EXCEL_MINREP15")
@NamedQuery(name="DataExcelMinrep15.findAll", query="SELECT d FROM DataExcelMinrep15 d")
public class DataExcelMinrep15 implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="DATA_EXCEL_MINREP15_SEQ", sequenceName="DATA_EXCEL_MINREP15_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="DATA_EXCEL_MINREP15_SEQ")
