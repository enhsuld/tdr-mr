...
if(filter!=null){
				...
				for(int i=0; i<arr.length();i++){
					...
					if(i>0){
						...
						switch(operator){
							case "startswith":flquery=flquery+  " "+logic+" lower("+filterfield+ ") LIKE lower('"+value+"%')"; break;
							case "contains":flquery=flquery+  " "+logic+" lower("+filterfield+ ") LIKE lower('%"+value+"%')"; break;
							case "doesnotcontain":flquery=flquery+  " "+logic+" lower("+filterfield+ ") NOT LIKE lower('%"+value+"%')"; break;
							case "endswith":flquery=flquery+  " "+logic+" lower("+filterfield+ ") LIKE lower('%"+value+"')"; break;
							case "neq":flquery=flquery+  " "+logic+" lower("+filterfield+ ") != lower('"+value+"')"; break;
							case "eq":flquery=flquery+  " "+logic+" lower("+filterfield+ ") = lower('"+value+"')"; break;
						}						
					}
					else{
						if(custom.length()>0){
							...
							if(custom.contains("orgid1")){
								...
								switch(operator){
									case "startswith":flquery=" Where lower("+filterfield+ ") LIKE lower('"+value+"%')"; break;
									case "contains":flquery=" Where lower("+filterfield+ ") LIKE lower('%"+value+"%')"; break;
									case "doesnotcontain":flquery=" Where lower("+filterfield+ ") NOT LIKE lower('%"+value+"%')"; break;
									case "endswith":flquery=" Where lower("+filterfield+ ") LIKE lower('%"+value+"')"; break;
									case "neq":flquery=" Where lower("+filterfield+ ") != lower('"+value+"')"; break;
									case "eq":flquery=" Where lower("+filterfield+ ") = lower('"+value+"')"; break;
								}								
							}
							else{
								...
								switch(operator){
									case "startswith":flquery=" "+custom+" and lower("+filterfield+ ") LIKE lower('"+value+"%')"; break;
									case "contains":flquery=" "+custom+" and lower("+filterfield+ ") LIKE lower('%"+value+"%')"; break;
									case "doesnotcontain":flquery=" "+custom+" and lower("+filterfield+ ") NOT LIKE lower('%"+value+"%')"; break;
									case "endswith":flquery=" "+custom+" and lower("+filterfield+ ") LIKE lower('%"+value+"')"; break;
									case "neq":flquery=" "+custom+" and lower("+filterfield+ ") != lower('"+value+"')"; break;
									case "eq":flquery=" "+custom+" and lower("+filterfield+ ") = lower('"+value+"')"; break;
								}
							}							
						}
						else{
	...
	public String insert(Object obj,LutUsers inserter){
		try{
			...
			if(inserter!=null) logger.fatal("\",\"a\":\"INSERT\" , \"User\":"+inserter.toString()+" , \"Obj\":"+obj.toString()+",\"end\":\"");
